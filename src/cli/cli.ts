...
import { OpenAIProvider, AnthropicProvider, LocalProvider } from '../providers/index.js';
import {
...
import { CalibrationMetrics } from '../calibration/metrics.js';
...
async function calibrateCommand(args: Record<string, string | boolean>) {
  ...
  const judgments: Array<{ judgment: import('../types/judgment.js').Judgment; humanLabel: number }> = [];
